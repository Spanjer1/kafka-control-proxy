...
public class SchemaRegistryServiceVertxEBProxy implements SchemaRegistryService {
  ...
  public SchemaRegistryServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public SchemaRegistryServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  @Override
  public Future<JsonObject> getSchema(String topicName, Integer version){
    ...
    _deliveryOptions.addHeader("action", "getSchema");
    _deliveryOptions.getHeaders().set("action", "getSchema");
