...
/**
 * Converter and mapper for {@link nl.reinspanjer.kcp.admin.ConfigEntry}.
 * NOTE: This class has been automatically generated from the {@link nl.reinspanjer.kcp.admin.ConfigEntry} original class using Vert.x codegen.
 */
      ...
      switch (member.getKey()) {
        ...
        case "synonyms":
          if (member.getValue() instanceof JsonArray) {
            java.util.ArrayList<nl.reinspanjer.kcp.admin.ConfigSynonym> list =  new java.util.ArrayList<>();
            ((Iterable<Object>)member.getValue()).forEach( item -> {
              if (item instanceof JsonObject)
                list.add(new nl.reinspanjer.kcp.admin.ConfigSynonym((io.vertx.core.json.JsonObject)item));
            });
